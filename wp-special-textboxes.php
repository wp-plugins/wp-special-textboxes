...
if (!class_exists("SpecialTextBoxes")) {
	class SpecialTextBoxes {
		...
		function addAdminHeaderCSS() {
			...
			echo "\n".'<script type="text/javascript" src="'.WP_PLUGIN_URL.'/wp-special-textboxes/js/colorpicker.js"></script>';
			echo "\n".'<script type="text/javascript" src="'.WP_PLUGIN_URL.'/wp-special-textboxes/js/eye.js"></script>';
			echo "\n".'<script type="text/javascript" src="'.WP_PLUGIN_URL.'/wp-special-textboxes/js/utils.js"></script>';
			echo "\n".'<script type="text/javascript" src="'.WP_PLUGIN_URL.'/wp-special-textboxes/js/layout.js"></script>';
