		...
		function getAdminOptions() {
			...
			if (!empty($stextboxesOptions)) {
				foreach ($stextboxesOptions as $key => $option)
					$stextboxesAdminOptions[$key] = (is_null($option)) ? $this->stextboxesInitOptions['$key'] : $option;
			}
